...
El modelo se basa en el **Teorema de Bayes** [@urafsky2023speech], que permite estimar la probabilidad de una clase $c$ dado un documento $d$:
...
La validación cruzada (cross-validation) es una técnica utilizada para evaluar el desempeño de un modelo dividiendo el conjunto de datos en k subconjuntos o folds. En cada iteración, el modelo se entrena sobre k – 1 folds y se evalúa en el fold restante. Al promediar las métricas obtenidas en las k repeticiones, se obtiene una estimación más robusta del rendimiento del modelo, lo que permite mitigar el riesgo de sobreajuste asociado a depender de un único conjunto de validación. En nuestro caso, se utilizó una validación cruzada con k=10.
