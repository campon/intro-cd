...
En este trabajo se analizan diferentes discursos políticos de la campaña presidencial de 2020 en Estados Unidos. 

La base de datos utilizada contiene un total de 269 observaciones y 6 variables que incluyen discursos de campaña, discursos en ayuntamientos, entrevistas, debates y otros eventos. Los discursos están clasificados por orador, título, contenido hablado, fecha, localidad y tipo de discurso. En particular, el análisis se centrará en los discursos de campaña política, con énfasis en los 5 principales oradores seleccionados según la mayor frecuencia de discursos.

Para identificar esta categoría de discursos, primero se realiza un análisis de los datos faltantes en la base. Las variables disponibles se clasifican en tres tipos principales: 
...
Los datos faltantes por variable se describen en la tabla **__**.
...
Solo se encuentran datos faltantes en las variables *speaker*, *location* y *type*. En particular, la variable *speaker* tiene 3 datos faltantes, *location* tiene 18 datos faltantes y *type* tiene 21 dato faltantes. Tras filtrar y quedarnos con los discursos de campaña, los datos faltantes que permanecen son 1 en *speaker* y 4 en *loaction*, esto no genera mayores consecuencias ya que no se perderá información relevante. En cuanto a la variable *type*, al filtrar por discursos de campaña, no quedan datos faltantes.

Para verificar la calidad de los datos, realizamos una visualización manual en busca de datos incompletos, datos inconsistentes, datos con ruido que probablemente sean provenientes de una mala producción y/o procesamiento de los mismos. La búsqueda no arroja mala calidad de los mismos, resultando haber una buena calidad de los mismos.
...
La cantidad de observaciones por type de discurso se resume en la tabla **__**. Se observa que 180 de las 269 observaciones, lo que representa un 72.6%, corresponden a discursos de campaña. Estos serán la base principal para nuestro análisis.
...
Los discursos de campaña abarcan un período que va desde el 15 de enero de 2020 hasta el 16 de octubre de 2020. La mediana de las fechas se sitúa a finales de agosto, lo que indica que la mayoría de los discursos se concentran en los últimos meses de la campaña.
...
Para normalizar el texto realizamos unas pequeñas modificaciones en la función de $\texttt{clean\_text()}$, agregamos los nombre de los candidatos, dado que nos dimos cuenta que en el texto del discurso se menciona el nombre y apellido del orador junto a dos puntos, ej. "Donald Trump:" esto generaba que los discursos de un mismo candidato tenga la aparición de su nombre y apellido repetitivamente por lo tanto se eliminan luego de convertir a minúsculas todo el texto, las frases: joe biden: donald trump: kamala harris: mike pence: bernie sanders: president trump: incluir los dos puntos junto al nombre y apellido, nos asegura no eliminar menciones que hace un orador sobre otro candidato. Adicionlamente agregamos otra sentencia que elimina los signos de puntuacion definidos y los reemplaza por espacios. Específicamente, eliminamos los caracteres: \[ \] , : ? . ! ; " ', además de saltos de línea (\\n), usando una expresión regular. Este proceso nos permite limpiar el texto antes de realizar análisis de texto.

# Parte 2\)
## Parte A\)

Los candidatos durante sus discursos utilizan un vocabulario similar, y ciertas palabras presentan una frecuencia mayor entre los mismos. En la figura **__** se observan las palabras mas frecuentes mencionadas en los discursos por candidatos.
...
Obsérvese que las 20 palabras más frecuentes en los discursos de todos los candidatos son mencionadas con mayor frecuencia por el orador Donald Trump. Esto podría indicar que los discursos de este candidato son más homogéneos entre sí en comparación con los de los demás oradores. Al agrupar las palabras más frecuentes por fórmula presidencial, se observa un patrón similar (véase la figura **__**), lo que permite identificar diferencias entre los discursos de los candidatos de los distintos partidos políticos. Si se analizaran las diferencias en los lugares y fechas de los discursos, sería posible generar listas de las localidades más visitadas por los candidatos, así como de los meses en los que se realizaron la mayor cantidad de discursos (véase la figura **__**).
...
Hay muchas palabras que utilizan unicamente las propias formulas, por ejemplo Donald y Mike utilizan un vocabulario "great", "years", "dont't", "right", "want" que Joe y Kamala no utilizan. Esto puede ser un indicativo de que los discursos de los candidatos son diferentes entre sí, y que existen distintas posturas políticas entre los mismos. Joe y Kamala utilizan palabras como "thank", "i'm", "get", "make", "back", "country" que no son utilizadas por la formula Trump-Pence, observamos un tipo de discurso mas inivididualista por el uso de la palabra "i'm" por parte de Joe y Kamala, mientras que la formula Trump-Pence utiliza un vocabulario más colectivo por el uso de "we're".

## Parte B\)

Al buscar las palabras mas frecuntes por candidatos, como ya comentamos, nos encontramos con un problema particular de que los propios candidatos se mencionan asi mismos con gran frecuencia, un patrón que se repetía en los 5 candidatos. Para resolver esto, decidimos filtrar las frases de los discrusos que mencionan al orador en el discurso lo cual causaba que los nombres de los mismos candidatos aparecieran con gran frecuencia.  
...
La figura _ muestra una matriz de menciones entre los candidatos. Las filas representan a los candidatos y las columnas indican las menciones hacia ellos. Para construir esta matriz, se elaboró una lista con los nombres de los candidatos y se contabilizaron las menciones de cada uno en los discursos de los demás. Por ejemplo, en los discursos de Donald Trump se buscaron menciones a Joe, a Biden y al nombre completo, siendo estas categorías excluyentes entre sí.

La diagonal principal de la matriz refleja la cantidad de veces que un candidato se menciona a sí mismo, mientras que el resto de la matriz muestra las menciones hacia otros candidatos. Se observa que Donald Trump y Joe Biden son quienes más se mencionan mutuamente, lo cual es lógico dado que fueron los principales opositores. Donald Trump es el candidato que más menciona al resto de los integrantes del top 5 de oradores. Por otro lado, Bernie Sanders es el único candidato que no menciona a los demás dentro del top 5, en particular a Mike Pence, y es también quien realiza menos menciones en general.
