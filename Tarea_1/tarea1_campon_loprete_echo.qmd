...
Para normalizar el texto realizamos unas pequeñas modificaciones en la función de $\texttt{clean\_text()}$, agregamos una sentencia que elimina los signos de puntuacion definidos y los reemplaza por espacios. Específicamente, eliminamos los caracteres: \[ \] , : ? . ! ; " ', además de saltos de línea (\\n), usando una expresión regular. Este proceso nos permite limpiar el texto antes de realizar análisis de texto.
